...
export const IconMic = ({ size, color, ...p }) => (
...
export const IconStethoscope = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconHeartPulse = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconBrain = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconFileText = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconLink = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconSave = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconUpload = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconClock = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconClipboard = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconMail = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconHospital = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconScalpel = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconTelescope = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconUserMd = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconBarChart = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconLock = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconZap = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconArrowRight = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconCross = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconDna = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconWifi = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconEye = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconCalendar = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconSmartphone = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconGlobe = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
    <circle cx="12" cy="12" r="10" />
...
export const IconPill = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconTrendingUp = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconUsers = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconChevronDown = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
    <polyline points="6 9 12 15 18 9" />
  </svg>
);

export const IconMenu = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
...
export const IconX = ({ size, color, ...p }) => (
  <svg {...defaults(size, color)} {...p}>
